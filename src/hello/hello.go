...
func main() {
	...
	books = append(books, Book{ID: "1", Isbn: "1323", Title: "learn GO", Author: &Author{Firstname: "Satyajit", Lastname: "Mohapatra"}})
	books = append(books, Book{ID: "2", Isbn: "4563", Title: "learn GO The Easy Way", Author: &Author{Firstname: "Dam", Lastname: "Smith"}})
